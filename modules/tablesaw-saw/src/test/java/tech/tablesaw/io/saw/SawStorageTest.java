...
class SawStorageTest {
  ...
  void bush() {
    ...
    String path = new SawWriter("build/testoutput/bush", bush).write();
    Table table = new SawReader(path).read();
  ...
  void tornado() {
    ...
    String path = new SawWriter("build/testoutput/tornadoes_1950-2014", tornado).write();
    Table table = new SawReader(path).read();
  ...
  @Test
  void baseball() {
    String path = new SawWriter("build/testoutput/baseball", baseball).write();
    Table table = new SawReader(path).read();
  ...
  void bostonRobberies() {
    ...
    String path = new SawWriter("build/testoutput/boston_robberies", robereries).write();
    Table table = new SawReader(path).read();
  ...
  void sacramento() {
    ...
    String path = new SawWriter("build/testoutput/sacramento", sacramento).write();
    Table table = new SawReader(path).read();
  ...
  void test_wines() {
    ...
    String path = new SawWriter("build/testoutput/test_wines", wines).write();
    Table table = new SawReader(path).read();
    ...
    new SawWriter("build/testoutput/test_wines", table);
