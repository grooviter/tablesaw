...
public enum TestData {
  SIMPLE_DATA_WITH_CANONICAL_DATE_FORMAT(
      new String[] {"Name", "IQ", "City", "DOB"},
      new ColumnType[] {
        ColumnType.STRING, ColumnType.DOUBLE, ColumnType.STRING, ColumnType.LOCAL_DATE
      },
      "../../data/simple-data-with-canonical-date-format.csv"),

  SIMPLE_UNSORTED_DATA(
      new String[] {"Name", "IQ", "City", "DOB"},
      new ColumnType[] {
        ColumnType.STRING, ColumnType.DOUBLE, ColumnType.STRING, ColumnType.LOCAL_DATE
      },
      "../../data/unsorted-simple-data.csv"),

  SIMPLE_SORTED_DATA_BY_DOUBLE_ASCENDING(
      new String[] {"Name", "IQ", "City", "DOB"},
      new ColumnType[] {
        ColumnType.STRING, ColumnType.DOUBLE, ColumnType.STRING, ColumnType.LOCAL_DATE
      },
      "../../data/simple-data-sort_by_int_ascending.csv"),

  SIMPLE_SORTED_DATA_BY_DOUBLE_DESCENDING(
      new String[] {"Name", "IQ", "City", "DOB"},
      new ColumnType[] {
        ColumnType.STRING, ColumnType.DOUBLE, ColumnType.STRING, ColumnType.LOCAL_DATE
      },
      "../../data/simple-data-sort_by_int_descending.csv"),

  SIMPLE_SORTED_DATA_BY_DOUBLE_ASCENDING_AND_THEN_DATE_DESCENDING(
      new String[] {"Name", "IQ", "City", "DOB"},
      new ColumnType[] {
        ColumnType.STRING, ColumnType.DOUBLE, ColumnType.STRING, ColumnType.LOCAL_DATE
      },
  ...
  SIMPLE_SORTED_DATA_BY_DOUBLE_AND_DATE_ASCENDING(
      new String[] {"Name", "IQ", "City", "DOB"},
      new ColumnType[] {
        ColumnType.STRING, ColumnType.DOUBLE, ColumnType.STRING, ColumnType.LOCAL_DATE
      },
  ...
  BUSH_APPROVAL(
      new String[] {"date", "approval", "who"},
      new ColumnType[] {ColumnType.LOCAL_DATE, ColumnType.DOUBLE, ColumnType.STRING},
      "../../data/bush.csv"),
  ...
  TestData(String[] columnNames, ColumnType[] columnTypes, String csvSource) {
    ...
    try {
      this.table =
          Table.read()
              .csv(CsvReadOptions.builder(new FileInputStream(csvSource)).columnTypes(columnTypes));
    } catch (IOException e) {
